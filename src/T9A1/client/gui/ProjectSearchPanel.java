...
public class ProjectSearchPanel extends JPanel{
	 ...
	 */
	public ProjectSearchPanel(KioskGUI g) {
		...
		JButton newSearch = new JButton("Item Search");
		newSearch.setFont(GUIConstants.LARGE_FONT);
		newSearch.addActionListener(new ItemSearchListener());
	...
	private class ItemSearchListener implements ActionListener{
		public void actionPerformed(ActionEvent e) {
			gui.showSearch(GUIConstants.ITEM_SEARCH);
		}
